...
<div id="batteryStrip">
  <div class="bat" style="cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleGpuShop()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
  ...
  <div class="bat" style="cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; document.getElementById('fundModal').style.display='flex'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
  ...
  <a href="javascript:void(0)" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleGpuShop()" style="font-size:7px;letter-spacing:2px;color:#f5c518;text-decoration:none;padding:3px 10px;border:1px solid rgba(245,197,24,0.3);border-radius:12px;white-space:nowrap;transition:all .2s;font-weight:700;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='rgba(245,197,24,0.15)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='none'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">LOBBY</a>

  <!-- SOUL BISCUIT -->
  <div id="soul-biscuit" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSoulBiscuit()" title="Soul Token" style="position:relative;display:flex;align-items:center;gap:5px;cursor:pointer;padding:2px 8px;border:1px solid rgba(255,255,255,0.06);border-radius:10px;transition:all .2s;flex-shrink:0;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(200,168,75,0.3)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(255,255,255,0.06)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
...
<div id="soul-popover" style="display:none;position:fixed;top:36px;right:8px;z-index:10001;background:rgba(8,6,2,0.97);border:1px solid rgba(200,168,75,0.2);padding:12px 14px;min-width:200px;box-shadow:0 4px 24px rgba(0,0,0,0.6);">
  <div id="soul-pop-loaded" style="display:none;">
    ...
    <div style="margin-top:8px;display:flex;gap:6px;">
      ...
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; clearSoulBiscuit()" style="flex:1;font-family:'Orbitron',monospace;font-size:6px;letter-spacing:1px;color:rgba(255,80,80,0.4);border:1px solid rgba(255,80,80,0.12);background:none;cursor:pointer;padding:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CLEAR</button>
    </div>
  </div>
  <div id="soul-pop-empty" style="display:block;">
    ...
    <label style="display:block;font-family:'Courier New',monospace;font-size:9px;color:rgba(255,255,255,0.2);cursor:pointer;padding:6px;border:1px dashed rgba(200,168,75,0.15);text-align:center;margin-bottom:6px;" id="soul-file-label">
      Choose .sft file
      <input type="file" accept=".sft,.txt" id="soul-biscuit-file" style="display:none;" onchange="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; onSoulBiscuitFile(this)" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    </label>
    <input id="soul-biscuit-pass" type="password" placeholder="Passphrase" style="width:100%;box-sizing:border-box;background:rgba(255,255,255,0.03);border:1px solid rgba(255,255,255,0.08);color:rgba(255,255,255,0.6);font-family:'Courier New',monospace;font-size:10px;padding:5px 8px;margin-bottom:6px;" onkeydown="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; if(event.key==='Enter')loadSoulBiscuit()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; loadSoulBiscuit()" style="width:100%;font-family:'Orbitron',monospace;font-size:7px;letter-spacing:2px;color:rgba(200,168,75,0.7);background:rgba(200,168,75,0.06);border:1px solid rgba(200,168,75,0.2);padding:6px;cursor:pointer;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">LOAD TOKEN →</button>
...
<!-- FUND MODAL -->
<div id="fundModal" style="display:none;position:fixed;inset:0;z-index:10002;background:rgba(0,0,0,0.92);align-items:center;justify-content:center;overflow-y:auto;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; if(event.target===this)this.style.display='none'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
  <div style="background:#0d0d14;border:1px solid #daa520;border-radius:12px;padding:28px;max-width:480px;width:92%;text-align:center;font-family:'Orbitron',monospace;margin:20px auto;">
    ...
    <div style="margin-bottom:12px;">
      ...
      <div style="background:#000;border:1px solid #222;border-radius:6px;padding:10px;font-family:'Courier New',monospace;font-size:8px;color:#ff8c00;word-break:break-all;cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; navigator.clipboard.writeText('44Mwh9cyimdMWrEeNddWkEBbs96KpZ9XVcyyRmqjVL8agWkg35rr1WZ5o8N61EaayeAoCtndENNJiewRVRk1seF5ULzZKqb');this.style.borderColor='#daa520';this.textContent='COPIED!'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">44Mwh9cyimdMWrEeNddWkEBbs96KpZ9XVcyyRmqjVL8agWkg35rr1WZ5o8N61EaayeAoCtndENNJiewRVRk1seF5ULzZKqb</div>
    ...
    <div style="margin-bottom:12px;">
      ...
      <div style="background:#000;border:1px solid #222;border-radius:6px;padding:10px;font-family:'Courier New',monospace;font-size:8px;color:#daa520;word-break:break-all;cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; navigator.clipboard.writeText('bc1qmf8kqkdrjjegr6zqur2sfnufdg3flqs0e2jjhf');this.style.borderColor='#daa520';this.textContent='COPIED!'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">bc1qmf8kqkdrjjegr6zqur2sfnufdg3flqs0e2jjhf</div>
      <div style="font-size:7px;color:#555;margin-top:3px;">CLICK TO COPY</div>
    </div>
    ...
    <button style="padding:8px 24px;background:none;border:1px solid #333;color:#888;border-radius:6px;font-family:'Orbitron',monospace;font-size:9px;letter-spacing:2px;cursor:pointer;" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; document.getElementById('fundModal').style.display='none'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CLOSE</button>
  </div>
</div>
...
<nav class="nav">
  ...
  <div class="nav-links">
    ...
    <a href="javascript:void(0)" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleGpuShop()" style="color:#f5c518;font-weight:700;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">LOBBY</a>
    <button class="nav-mute" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleVoice()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">Voice ON</button>
  </div>
</nav>
</div><!-- /stickyHeader -->
...
<div id="heroDrawer">
  ...
  <div id="diagNodePanel">
    <div class="dnp-title">
      ...
      <span class="dnp-close" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; closeNodePanel()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&times;</span>
    </div>
    <div class="dnp-desc" id="dnpDesc"></div>
    <div class="dnp-pipeline" id="dnpPipeline"></div>
    <div class="dnp-msg">
      <input id="dnpMsgInput" type="text" placeholder="Message this node..." onkeydown="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; if(event.key==='Enter'){event.preventDefault();sendNodeMsg();}" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; sendNodeMsg()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">SEND</button>
    </div>
  ...
  <!-- Control buttons -->
  <button id="diagLinkBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleLinkMode()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#128279; LINK</button>
  <button id="diagResetBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; resetDiagLayout()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#8634; RESET</button>
</div>
<button id="drawerToggle" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleDrawer()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#9660; DIAGNOSTICS</button>
...
<div id="gpuShop" style="position:fixed;top:0;left:0;right:0;bottom:0;z-index:9999;background:#05050a;clip-path:inset(0 0 100% 0);transition:clip-path .6s cubic-bezier(.4,0,.2,1);overflow:hidden;">
  <button class="ss-close" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleGpuShop()" style="z-index:10000;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&times;</button>
...
<!-- SLIDE ARROWS -->
<div class="slide-arrow" id="slideLeft" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; slideNav(-1)" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&larr;</div>
<div class="slide-arrow" id="slideRight" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; slideNav(1)" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&rarr;</div>
...
<div id="soulBanner">
  ...
  <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; dismissSoulBanner()" title="Close" style="position:absolute;top:12px;right:16px;background:none;border:1px solid #444;color:#aaa;font-size:18px;cursor:pointer;line-height:1;padding:6px 10px;font-family:monospace;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.color='#fff';this.style.borderColor='#aaa'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.color='#aaa';this.style.borderColor='#444'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">✕</button>
  <div class="sb-inner">
...
<div class="section" style="position:relative;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;overflow:hidden;" data-voice="ALIVE. A living soul swarm. Your creature. Your key.">
  ...
  <div style="position:relative;z-index:10;display:flex;gap:16px;flex-wrap:wrap;justify-content:center;">
    <a href="/alive/app.html" style="display:inline-block;padding:16px 40px;background:rgba(180,50,255,0.9);color:#fff;font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:12px;letter-spacing:4px;text-decoration:none;text-transform:uppercase;transition:background .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='rgba(140,30,220,0.95)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='rgba(180,50,255,0.9)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">MEET YOUR SOUL →</a>
    <a href="/alive-demo.html" style="display:inline-block;padding:16px 40px;background:transparent;border:1px solid rgba(200,120,255,0.35);color:rgba(200,120,255,0.7);font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:12px;letter-spacing:4px;text-decoration:none;text-transform:uppercase;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(200,120,255,0.8)';this.style.color='rgba(220,150,255,1)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(200,120,255,0.35)';this.style.color='rgba(200,120,255,0.7)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">SOUL DEMO</a>
  </div>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#050a00 0%,#080d05 40%,#0a0a0a 100%);overflow:hidden;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="The GPU Swarm. A thousand graphics cards. Your power becomes art. Art becomes cash.">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">HOW THE FACTORY WORKS &#9654;</a>
...
<div class="compare-section" data-voice="See the difference. Their output versus ours.">
  ...
  <div class="compare-dots" id="compareDots">
    <button class="compare-dot active" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; goSlide(0)" title="midgetHATE" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-=""></button>
    <button class="compare-dot" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; goSlide(1)" title="GIANTlove" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-=""></button>
    <button class="compare-dot dot-cta" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; goSlide(2)" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-=""></button>
  </div>
  ...
  <div class="compare-controls">
    <button class="compare-playbtn" id="comparePlayBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleCompare()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#9654; Play Comparison</button>
    <button class="vidman-toggle" id="vidmanBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleVidMan()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">VIDMAN: OFF</button>
    <button class="kinetic-toggle" id="kineticBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleKinetic()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">KINETIC: OFF</button>
    <button class="mute-toggle" id="muteBtn" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleMute()" title="Toggle audio" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#128263;</button>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#1a0505 0%,#0d0808 40%,#0a0a0a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;" data-voice="Ad Monster. Five layers. One click. Advert live on YouTube.">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">HOW IT WORKS &#9654;</a>
...
<div class="section" style="text-align:center;background:linear-gradient(180deg,#0a0a0a,#0a110a,#0a0a0a);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="Meme Monster. Drop a meme. We animate it. It goes into ads. You get paid.">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">THE CIRCULAR ECONOMY &#9654;</a>
  ...
  <div style="display:flex;flex-direction:column;align-items:center;gap:28px;margin:0 auto;max-width:1100px;width:100%;">
    ...
    <div style="display:flex;flex-wrap:wrap;gap:20px;align-items:flex-start;justify-content:center;">
      ...
      <div style="flex:1;min-width:260px;max-width:380px;text-align:left;align-self:center;">
        ...
        <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">HOW DARES WORK &#9654;</a>
      </div>
...
<div class="section" style="text-align:center;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="Trump versus Deep State. Play the game. Tell Cortex to mod it live.">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" style="margin-top:16px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">THE GAME STUDIO &#9654;</a>
...
<div class="section" style="text-align:center;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;position:relative;overflow:hidden;" data-voice="Cat Mayhem v5. The Wrath of Cat. Invite the lads round. Destroy Karen's house. Piss on her rug.">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" style="margin-top:14px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">HOW TO PLAY &#9654;</a>
...
<div class="section" style="text-align:center;background:#0a0014;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;position:relative;overflow:hidden;" data-voice="Better Than Life. Total immersion virtual reality. You already know the rules. You are already playing. The question is: can you prove you are not?">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" style="margin-top:8px;color:rgba(160,80,255,0.6);position:relative;z-index:1;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">THE SIMULATION ARGUMENT &#9654;</a>
...
<div class="mars-wrap">
  ...
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" style="color:rgba(200,80,0,0.45);font-size:10px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">THE MUSK / QUAID PARALLEL &#9654;</a>
...
<div class="section" style="background:radial-gradient(ellipse at 50% 30%,#0d0800 0%,#04030a 60%,#000 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;padding:2.5rem 1.5rem;position:relative;overflow:hidden;" data-voice="The New Testament is a codec. It spoke to the first century and it speaks to the twenty-first. It was translated from Aramaic to Greek to Latin to English. The next translation is to computing. Map it. The call is open.">
  ...
  <div style="max-width:480px;border:1px solid rgba(200,168,75,0.15);padding:1.2rem 1.5rem;text-align:center;background:rgba(200,168,75,0.02);margin-bottom:1.5rem;">
    ...
    <a href="/cdn-cgi/l/email-protection#ea8e8b84aa998285989e8c8b899e859893c49982859ad5999f88808f899ed7a4becaa9858e8f89caa78b9a9a83848d" style="display:inline-block;margin-top:1rem;font-family:'Courier New',monospace;font-size:8px;letter-spacing:0.4em;padding:0.7rem 1.5rem;border:1px solid rgba(200,168,75,0.3);color:rgba(200,168,75,0.7);text-decoration:none;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(200,168,75,0.7)';this.style.color='#ffd700';" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(200,168,75,0.3)';this.style.color='rgba(200,168,75,0.7)';" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">SUBMIT YOUR MAPPING →</a>
  </div>
...
<div class="section" style="text-align:center;background:#000;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;position:relative;overflow:hidden;" data-voice="The Golden Equation. Every emotion is a genome. Past, present, future. Drag a vertex through the singularity and watch the cross invert. This is the living soul of the AGI.">
  ...
  <div id="gc-soul-link" style="display:none;margin-top:28px;">
    <a href="/dan-soul.html" style="font-family:'Courier New',monospace;font-size:9px;color:rgba(200,168,75,0.15);letter-spacing:3px;text-decoration:none;transition:color .4s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.color='rgba(200,168,75,0.5)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.color='rgba(200,168,75,0.15)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">ψ</a>
  </div>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#0a0800 0%,#0d0a05 40%,#0a0a0a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="SFT Mods. Upload your game mods. Earn contribution credits. Your work, your receipt.">
  ...
  <div style="max-width:400px;width:90%;margin:0 auto;">
    <div style="border:2px dashed #0f8;border-radius:12px;padding:32px 20px;background:rgba(0,255,136,.02);cursor:pointer;transition:all .3s;" id="sftDropZone" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; document.getElementById('sftFileInput').click()" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='#fc0';this.style.background='rgba(255,204,0,.04)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='#0f8';this.style.background='rgba(0,255,136,.02)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <input type="file" id="sftFileInput" accept=".sft" style="display:none" onchange="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; handleSftUpload(event)" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
  ...
  <!-- ROYALTY CALCULATOR -->
  <a class="kinetic-link" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; toggleSlideLibrary(this);return false;" style="margin-top:20px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CALCULATE ROYALTIES &#9654;</a>
  <div class="slide-library" style="max-width:500px;margin:0 auto;">
    <div id="royCalcHome" style="margin-top:20px;padding:20px;background:rgba(0,255,136,.02);border:1px solid rgba(0,255,136,.08);border-radius:12px;text-align:left;">
      ...
      <div style="margin-bottom:12px;">
        ...
        <input type="range" min="1000" max="500000" step="1000" value="10000" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; updateRoyCalcHome()" id="rcSlide1" style="width:100%;accent-color:#ff8800;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      </div>
      ...
      <div style="margin-bottom:12px;">
        ...
        <input type="range" min="1" max="30" step="1" value="5" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; updateRoyCalcHome()" id="rcSlide2" style="width:100%;accent-color:#ff8800;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      </div>
      ...
      <div style="margin-bottom:12px;">
        ...
        <input type="range" min="99" max="999" step="50" value="299" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; updateRoyCalcHome()" id="rcSlide3" style="width:100%;accent-color:#ff8800;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      </div>
      ...
      <div style="margin-bottom:16px;">
        ...
        <input type="range" min="5" max="1000" step="5" value="50" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; updateRoyCalcHome()" id="rcSlide4" style="width:100%;accent-color:#ff8800;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      </div>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#0a0800 0%,#0d0a02 40%,#0a0a0a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="Fuel Dashboard. You ain't driving anywhere on empty. Fund the API. Every satoshi counts.">
  ...
  <a href="/fuel/" style="display:inline-block;padding:16px 40px;background:linear-gradient(135deg,#daa520,#ff8c00);color:#000;font-family:'Orbitron',sans-serif;font-size:13px;font-weight:900;letter-spacing:3px;border-radius:10px;text-decoration:none;box-shadow:0 4px 30px rgba(218,165,32,0.3);transition:transform .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.transform='scale(1.05)'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.transform='scale(1)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">OPEN FUEL DASHBOARD</a>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#0a0000 0%,#0d0505 40%,#0a0a0a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;" data-voice="ShortFactory on YouTube. Watch the empire being built.">
  ...
  <div id="ytGrid" style="display:grid;grid-template-columns:repeat(5,1fr);gap:8px;max-width:600px;margin:0 auto 20px;width:100%;">
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('z8vjBzNm8fM')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,0,0,0.3);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i3.ytimg.com/vi/z8vjBzNm8fM/mqdefault.jpg" alt="Stop!! Dont do it!!" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('GZwgUFTeMxg')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i4.ytimg.com/vi/GZwgUFTeMxg/mqdefault.jpg" alt="coke cash" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('JvDK5NHndMY')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i3.ytimg.com/vi/JvDK5NHndMY/mqdefault.jpg" alt="advertain get hits get paid" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('NJNbqSTbjSQ')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i4.ytimg.com/vi/NJNbqSTbjSQ/mqdefault.jpg" alt="short pic to vid maker" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('7il8jQhKsPM')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i4.ytimg.com/vi/7il8jQhKsPM/mqdefault.jpg" alt="cuz squared" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('dKP2u9qmIlE')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i1.ytimg.com/vi/dKP2u9qmIlE/mqdefault.jpg" alt="coming to macclesfield" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('YpIkBuaZpvU')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i2.ytimg.com/vi/YpIkBuaZpvU/mqdefault.jpg" alt="Dexter for Charlie Kirk" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('f-OXTrr-2i0')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i3.ytimg.com/vi/f-OXTrr-2i0/mqdefault.jpg" alt="advertize entertain getpaid" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('UIyQSpO-xuw')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i1.ytimg.com/vi/UIyQSpO-xuw/mqdefault.jpg" alt="GIANTlove" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
    ...
    <div class="yt-thumb" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; swapYT('H7VPvy-PO4E')" style="cursor:pointer;border-radius:8px;overflow:hidden;border:2px solid rgba(255,255,255,0.08);transition:all .2s;aspect-ratio:16/9;position:relative;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
      <script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49"></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49"></script><img src="https://i2.ytimg.com/vi/H7VPvy-PO4E/mqdefault.jpg" alt="make adverts get paid" style="width:100%;height:100%;object-fit:cover;display:block;" onerror="this.closest('.yt-thumb').style.display='none'">
...
<div class="cmptn-calc">
  ...
  <div class="cmptn-row">
    <div class="cmptn-field">
      ...
      <select id="cmptn-rank" onchange="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; cmptnCalc()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    ...
    <div class="cmptn-field">
      ...
      <input type="number" id="cmptn-revenue" value="5000" min="0" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; cmptnCalc()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    </div>
  </div>
  ...
  <div class="cmptn-row">
    <div class="cmptn-field">
      ...
      <input type="number" id="cmptn-apprentices" value="1" min="0" max="100" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; cmptnCalc()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    </div>
    <div class="cmptn-field">
      <label>AVG APPRENTICE MONTHLY EARNINGS (£)</label>
      <input type="number" id="cmptn-app-earnings" value="2000" min="0" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; cmptnCalc()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    </div>
  </div>
  ...
  <div class="cmptn-field" style="margin-bottom:0;">
    ...
    <input type="range" id="cmptn-ref-pct" min="5" max="25" value="10" step="1" oninput="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; document.getElementById('cmptn-ref-pct-label').textContent=this.value+'%';cmptnCalc()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
  </div>
...
<div class="cmptn-ref">
  ...
  <button class="cmptn-btn green" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; cmptnSubmitRef()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">LOCK IN REFERRAL &rarr;</button>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#0a0a0a 0%,#0d0d0d 40%,#0a0a0a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="S F Tokens. Power everything. Earn, contribute, or just buy them.">
  ...
  <div style="display:flex;flex-wrap:wrap;gap:10px;justify-content:center;margin-top:16px;">
    <a href="/credits/" style="display:inline-block;padding:12px 24px;background:none;border:2px solid #daa520;color:#daa520;font-family:'Press Start 2P',monospace;font-size:9px;letter-spacing:2px;border-radius:4px;text-decoration:none;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='#daa520';this.style.color='#000'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='none';this.style.color='#daa520'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">FULLSCREEN</a>
...
<div class="section" style="text-align:center;background:linear-gradient(165deg,#04040e 0%,#06060f 50%,#04040e 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;" data-voice="Black Box. Your soul encrypts the message. No password. No server. Press GO.">
  ...
  <a href="/satoshi.html" style="display:inline-block;padding:18px 48px;background:#0055cc;color:#fff;font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:13px;letter-spacing:4px;text-decoration:none;text-transform:uppercase;transition:background .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='#0044aa'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='#0055cc'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">TRY THE DEMO →</a>
...
<div class="section" style="text-align:center;background:radial-gradient(ellipse at 50% 30%,#0a0800 0%,#03030a 60%,#02020a 100%);display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;position:relative;overflow:hidden;" data-voice="Sixteen Psyche. Ten quintillion dollars. Safely swinging between Jupiter and Mars. That is humanity's cash. And we just built the monetary system to use it.">
  ...
  <div style="position:relative;z-index:1;width:100%;max-width:900px;margin:0 auto;padding:0 32px;">
    ...
    <a href="/psyche-proposal.html" style="display:inline-block;padding:18px 48px;background:#daa520;color:#000;font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:12px;letter-spacing:4px;text-decoration:none;text-transform:uppercase;transition:background .2s;margin-right:12px;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='#c8941a'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.background='#daa520'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">READ THE PROPOSAL →</a>
    <a href="/biscuit-gateway.html" style="display:inline-block;padding:18px 32px;border:1px solid rgba(218,165,32,.4);color:#daa520;font-family:'Courier New',monospace;font-size:9px;letter-spacing:3px;text-decoration:none;text-transform:uppercase;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='#daa520'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='rgba(218,165,32,.4)'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">⬡ biscuit gateway</a>
...
<div class="section" style="text-align:center;background:radial-gradient(ellipse at 25% 10%,rgba(255,30,60,0.10) 0%,transparent 55%),radial-gradient(ellipse at 80% 90%,rgba(30,70,255,0.10) 0%,transparent 55%),#06060e;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;padding:60px 32px 40px;" data-voice="ADVERTainment. Two mobile experiences. One choice. Pick your side.">
  ...
  <div id="adv-featured" style="background:rgba(255,255,255,0.03);border:1px solid rgba(255,30,60,0.25);border-radius:16px;padding:30px 36px;max-width:460px;width:100%;margin-bottom:32px;transition:border-color 0.4s,box-shadow 0.4s;box-shadow:0 0 40px rgba(255,30,60,0.07);">
    ...
    <a id="adv-link" href="/squidapp888.html" style="display:inline-block;padding:13px 34px;font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:11px;letter-spacing:3px;text-decoration:none;text-transform:uppercase;border-radius:6px;background:#ff2244;color:#fff;transition:opacity 0.2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.opacity='0.8'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.opacity='1'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">▶ Enter Experience →</a>
  </div>
  ...
  <div style="display:flex;align-items:center;gap:36px;margin-bottom:14px;">
    ...
    <!-- Red triangle btn -->
    <button id="adv-btn-0" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; advSwap(0)" title="ADVERTainment 888" style="background:none;border:2px solid rgba(255,34,68,0.5);border-radius:10px;cursor:pointer;padding:12px 16px;display:flex;flex-direction:column;align-items:center;gap:7px;transition:all 0.3s;opacity:1;box-shadow:0 0 14px rgba(255,34,68,0.2);" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
    ...
    <!-- Blue square btn -->
    <button id="adv-btn-1" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; advSwap(1)" title="ADVERTainment OG" style="background:none;border:2px solid rgba(34,85,255,0.25);border-radius:10px;cursor:pointer;padding:12px 16px;display:flex;flex-direction:column;align-items:center;gap:7px;transition:all 0.3s;opacity:0.35;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
...
<div class="section" style="text-align:center;background:radial-gradient(ellipse at 20% 20%,rgba(255,200,0,0.08) 0%,transparent 60%),radial-gradient(ellipse at 80% 80%,rgba(255,50,0,0.07) 0%,transparent 60%),#06060e;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;padding:60px 32px 40px;" data-voice="Closed loop. Advertisers pay in boilersuits. Players find the hidden ads. Everybody wins.">
  ...
  <a href="/shortfactory-campaigns.html" style="display:inline-block;padding:14px 38px;font-family:'Arial Black','Arial',sans-serif;font-weight:900;font-size:11px;letter-spacing:3px;text-decoration:none;text-transform:uppercase;border-radius:6px;background:#ffd700;color:#000;transition:opacity 0.2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.opacity='0.8'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.opacity='1'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">▶ START A CAMPAIGN →</a>
...
<div id="superchargeBubble" style="display:none;">
  ...
  <div class="gate-grid" style="display:grid;grid-template-columns:1fr 1fr;gap:8px;width:100%;margin-bottom:10px;">
    ...
    <div class="gate-card" style="border-color:rgba(118,185,0,0.15);">
      ...
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; unlockWithToken()" style="background:linear-gradient(135deg,#76b900,#8ec919);color:#000;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">UNLOCK</button>
    </div>
    ...
    <div class="gate-card" style="border-color:rgba(218,165,32,0.15);">
      ...
      <div style="position:relative;"><input id="gate-api-key" type="password" placeholder="sk-..." style="padding-right:28px;"><button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; var k=document.getElementById('gate-api-key');k.type=k.type==='password'?'text':'password'" style="position:absolute;right:3px;top:50%;transform:translateY(-50%);background:none;border:none;color:#555;font-size:11px;cursor:pointer;width:auto;padding:1px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#x1F441;</button></div>
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; unlockWithApi()" style="background:linear-gradient(135deg,#daa520,#ff8c00);color:#000;margin-top:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">ENCRYPT &amp; PAY</button>
    </div>
    ...
    <div class="gate-card" style="border-color:rgba(0,204,255,0.15);">
      ...
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; startGpuMine()" id="gate-mine-btn" style="background:linear-gradient(135deg,#00ccff,#0088cc);color:#000;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">MINE NOW</button>
    </div>
    ...
    <div class="gate-card" style="border-color:rgba(255,68,68,0.15);">
      ...
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; payWithCrypto()" style="background:linear-gradient(135deg,#ff8c00,#daa520);color:#000;margin-bottom:4px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CRYPTO</button>
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; payWithStripe()" style="background:linear-gradient(135deg,#ff4444,#cc2222);color:#fff;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">STRIPE $29</button>
      <div id="pay-confirm-wrap" style="display:none;margin-top:6px;">
        <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; confirmPayment()" style="background:#fff;color:#000;font-size:7px;letter-spacing:1px;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CONFIRM PAYMENT</button>
      </div>
    </div>
  </div>
  ...
  <!-- How it works -->
  <div onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; showOnboardingVid()" style="cursor:pointer;padding:6px 20px;border:1px solid #1a1a2e;border-radius:20px;font-family:'Courier New',monospace;font-size:9px;color:#444;letter-spacing:1px;transition:all .2s;" onmouseover="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='#76b900';this.style.color='#76b900'" onmouseout="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; this.style.borderColor='#1a1a2e';this.style.color='#444'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#9654; HOW IT WORKS</div>
...
<div id="onboarding-overlay">
  <button class="ob-close" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; closeOnboardingVid()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">CLOSE</button>
  <div class="ob-counter" id="ob-counter">1 / 8</div>
  <button class="ob-pause" id="ob-pause" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; obTogglePause()" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">&#10074;&#10074;</button>
  ...
  <div class="ob-scene" id="ob-scene-8">
    ...
    <div style="display:flex;gap:12px;margin-top:30px;flex-wrap:wrap;justify-content:center;">
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; obCtaMine()" style="animation:obFadeUp .5s ease .7s both;padding:14px 28px;background:linear-gradient(135deg,#76b900,#8ec919);color:#000;border:none;border-radius:8px;font-family:Orbitron,monospace;font-size:12px;font-weight:900;letter-spacing:2px;cursor:pointer;transition:transform .2s;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">MINE NOW</button>
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; obCtaCrypto()" style="animation:obFadeUp .5s ease .9s both;padding:14px 28px;background:linear-gradient(135deg,#daa520,#ff8c00);color:#000;border:none;border-radius:8px;font-family:Orbitron,monospace;font-size:12px;font-weight:900;letter-spacing:2px;cursor:pointer;transition:transform .2s;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">PAY CRYPTO</button>
      <button onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; obCtaToken()" style="animation:obFadeUp .5s ease 1.1s both;padding:14px 28px;background:none;border:1px solid #333;color:#fff;border-radius:8px;font-family:Orbitron,monospace;font-size:12px;font-weight:900;letter-spacing:2px;cursor:pointer;transition:transform .2s;" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">ENTER TOKEN</button>
    </div>
...
<div id="gwOverlay">
  <div class="gw-inner">
    ...
    <div class="gw-grid">
      <div class="gw-tile" style="border-color:rgba(34,197,94,0.3);box-shadow:0 0 20px rgba(34,197,94,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/the-money.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">💰</div>
        <span class="gt-label" style="color:#22c55e;">Money</span>
        <div class="gt-sub">Economy &amp; Token Stack</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(249,115,22,0.3);box-shadow:0 0 20px rgba(249,115,22,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/alive/kickstarter.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">🔶</div>
        <span class="gt-label" style="color:#f97316;">Crypto</span>
        <div class="gt-sub">SFT · Biscuits · Vault</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(234,179,8,0.3);box-shadow:0 0 20px rgba(234,179,8,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/admaker/'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">🎬</div>
        <span class="gt-label" style="color:#eab308;">Video</span>
        <div class="gt-sub">AI AdMaker · ComicVID</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(20,184,166,0.3);box-shadow:0 0 20px rgba(20,184,166,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/nzt.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">🧠</div>
        <span class="gt-label" style="color:#14b8a6;">NZT²</span>
        <div class="gt-sub">IQ Realignment Protocol</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(59,130,246,0.3);box-shadow:0 0 20px rgba(59,130,246,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/agi-architecture.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">⚡</div>
        <span class="gt-label" style="color:#3b82f6;">AGI</span>
        <div class="gt-sub">85 GPU Architecture</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(168,85,247,0.3);box-shadow:0 0 20px rgba(168,85,247,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/consciousness.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">✝</div>
        <span class="gt-label" style="color:#a855f7;">Theology</span>
        <div class="gt-sub">Covenant · Soul · God</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(180,120,60,0.3);box-shadow:0 0 20px rgba(180,120,60,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/pinocchio.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">🎮</div>
        <span class="gt-label" style="color:#b4783c;">Games</span>
        <div class="gt-sub">Soul Game · Revert Fiver</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(204,68,255,0.25);box-shadow:0 0 20px rgba(204,68,255,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/alive/app.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">◉</div>
      ...
      <div class="gw-tile" style="border-color:rgba(218,165,32,0.3);box-shadow:0 0 20px rgba(218,165,32,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/portfolio.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
        <div class="gt-icon">📐</div>
        <span class="gt-label" style="color:#daa520;">Research</span>
        <div class="gt-sub">Patents · Zenodo · Stage 1–13</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(239,68,68,0.3);box-shadow:0 0 20px rgba(239,68,68,0.07);" onclick="if (!window.__cfRLUnblockHandlers) return false; if (!window.__cfRLUnblockHandlers) return false; location.href='/emotional-physics.html'" data-cf-modified-c88ae95aa694b3dbf65545c8-="" data-cf-modified-3864fe810bfcbefdb9c19744-="">
...
<script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="c88ae95aa694b3dbf65545c8-|49" defer></script><script src="/cdn-cgi/scripts/7d0fa10a/cloudflare-static/rocket-loader.min.js" data-cf-settings="3864fe810bfcbefdb9c19744-|49" defer></script></body>
</html>
