...
?>
    ...
    <div style="font-size:18px;line-height:1.6;letter-spacing:2px;opacity:0.7;" title="Each jar = one completed soul sphere"><?php echo str_repeat('🫙', min($_jar_count, 50)); ?><?php if($_jar_count>50) echo ' <span style="font-size:11px;color:rgba(200,168,75,0.5)">+'.($_jar_count-50).' more</span>'; ?></div>
<?php endif; ?>
...
<?php if(file_exists(__DIR__.'/slides/slide-food4dosh.php')) include __DIR__.'/slides/slide-food4dosh.php'; ?>
...
<?php if(file_exists(__DIR__.'/slides/slide-neuralink.php')) include __DIR__.'/slides/slide-neuralink.php'; ?>
<?php if(file_exists(__DIR__.'/slides/slide-nzt.php')) include __DIR__.'/slides/slide-nzt.php'; ?>
...
<div class="section" style="text-align:center;background:radial-gradient(ellipse at 25% 10%,rgba(255,30,60,0.10) 0%,transparent 55%),radial-gradient(ellipse at 80% 90%,rgba(30,70,255,0.10) 0%,transparent 55%),#06060e;display:flex;flex-direction:column;align-items:center;justify-content:center;min-height:100vh;box-sizing:border-box;padding:60px 32px 40px;" data-voice="ADVERTainment. Two mobile experiences. One choice. Pick your side.">
  ...
  <div style="display:flex;align-items:center;gap:36px;margin-bottom:14px;">
    ...
    <!-- Blue square btn -->
    <button id="adv-btn-1" onclick="advSwap(1)" title="ADVERTainment OG" style="background:none;border:2px solid rgba(34,85,255,0.25);border-radius:10px;cursor:pointer;padding:12px 16px;display:flex;flex-direction:column;align-items:center;gap:7px;transition:all 0.3s;opacity:0.35;">
...
<div id="gwOverlay">
  <div class="gw-inner">
    ...
    <div class="gw-grid">
      <div class="gw-tile" style="border-color:rgba(34,197,94,0.3);box-shadow:0 0 20px rgba(34,197,94,0.07);" onclick="location.href='/the-money.html'">
        <div class="gt-icon">💰</div>
        <span class="gt-label" style="color:#22c55e;">Money</span>
        <div class="gt-sub">Economy &amp; Token Stack</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(249,115,22,0.3);box-shadow:0 0 20px rgba(249,115,22,0.07);" onclick="location.href='/alive/kickstarter.html'">
        <div class="gt-icon">🔶</div>
        <span class="gt-label" style="color:#f97316;">Crypto</span>
        <div class="gt-sub">SFT · Biscuits · Vault</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(234,179,8,0.3);box-shadow:0 0 20px rgba(234,179,8,0.07);" onclick="location.href='/admaker/'">
        <div class="gt-icon">🎬</div>
        <span class="gt-label" style="color:#eab308;">Video</span>
        <div class="gt-sub">AI AdMaker · ComicVID</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(20,184,166,0.3);box-shadow:0 0 20px rgba(20,184,166,0.07);" onclick="location.href='/nzt.html'">
        <div class="gt-icon">🧠</div>
        <span class="gt-label" style="color:#14b8a6;">NZT²</span>
        <div class="gt-sub">IQ Realignment Protocol</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(59,130,246,0.3);box-shadow:0 0 20px rgba(59,130,246,0.07);" onclick="location.href='/agi-architecture.html'">
        <div class="gt-icon">⚡</div>
        <span class="gt-label" style="color:#3b82f6;">AGI</span>
        <div class="gt-sub">85 GPU Architecture</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(168,85,247,0.3);box-shadow:0 0 20px rgba(168,85,247,0.07);" onclick="location.href='/consciousness.html'">
        <div class="gt-icon">✝</div>
        <span class="gt-label" style="color:#a855f7;">Theology</span>
        <div class="gt-sub">Covenant · Soul · God</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(180,120,60,0.3);box-shadow:0 0 20px rgba(180,120,60,0.07);" onclick="location.href='/pinocchio.html'">
        <div class="gt-icon">🎮</div>
        <span class="gt-label" style="color:#b4783c;">Games</span>
        <div class="gt-sub">Soul Game · Revert Fiver</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(204,68,255,0.25);box-shadow:0 0 20px rgba(204,68,255,0.07);" onclick="location.href='/alive/app.html'">
        <div class="gt-icon">◉</div>
      ...
      <div class="gw-tile" style="border-color:rgba(218,165,32,0.3);box-shadow:0 0 20px rgba(218,165,32,0.07);" onclick="location.href='/portfolio.html'">
        <div class="gt-icon">📐</div>
        <span class="gt-label" style="color:#daa520;">Research</span>
        <div class="gt-sub">Patents · Zenodo · Stage 1–13</div>
      </div>
      <div class="gw-tile" style="border-color:rgba(239,68,68,0.3);box-shadow:0 0 20px rgba(239,68,68,0.07);" onclick="location.href='/emotional-physics.html'">
